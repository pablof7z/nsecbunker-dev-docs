...
## Connecting
This step is kinda optional, but I think it's a good idea. It'll send a NIP-46 `connect` command to the nsecBunker; the nsecBunker will `ok` if/when the local private key is authorized to connect.
